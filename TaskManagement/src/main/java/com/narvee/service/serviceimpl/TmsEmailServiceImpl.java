...
public class TmsEmailServiceImpl {
	...
	public void sendCreateProjectEmail(TmsProject project, List<GetUsersDTO> userdetails, boolean projectUpdate,
		...
		if (projectUpdate) {
			subject = (Emailsubject != null && !Emailsubject.isBlank()) ? Emailsubject
	...
	// ------------------Send email for task create and update for task
	// management-----------------
	@Async
	public void TaskAssigningEmailForTMS(TmsTask task, List<GetUsersDTO> userdetails, boolean isTask,
			String Emailsubject, List<String> bccMails, List<String> CcMails) // task created and updated email for TMS
																				// project
			throws MessagingException, UnsupportedEncodingException {
...
//		helper.setCc(ccmail);
	...
	public void sendCreateSubTaskEmail(TmsSubTask subtask, List<GetUsersDTO> userdetails, boolean SubTaskUpdate,
		...
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd MMMM yyyy");
		String formattedStartDate = subtask.getStartDate() != null ? formatter.format(subtask.getStartDate())
				: "Not available";
		String formattedTargetDate = subtask.getTargetDate() != null ? formatter.format(subtask.getTargetDate())
				: "Not available";
...
//		helper.setCc(ccmail);
		...
		if (SubTaskUpdate) {
			...
			body = "<!DOCTYPE html>" + "<html><head><meta charset='UTF-8'><title>New Sub Task Assigned</title></head>"
					...
					+ "<tr><td style='font-weight: bold; vertical-align: top;'>Description:</td>"
					+ "<td style='width: 600px; white-space: normal; '>" + subtask.getSubTaskDescription()
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Created By:</td><td>" + createdBy
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Start Date :</td><td>" + formattedStartDate
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Target Date :</td><td>" + formattedTargetDate
					+ "</td></tr>"
					+ "<tr><td style='font-weight: bold; white-space: nowrap; vertical-align: top;'>Assigned Users:</td>"
					+ "<td style='white-space: normal;'>" + users + "</td></tr>" + "</table>"
					+ "<p style='font-size: 14px; margin-top: 20px;'>Please log in to the portal to begin your work.</p>"
					+ "</td></tr>"
					+ "<tr><td style='background-color: #f0f0f0; padding: 20px; text-align: center; color: #555; border-bottom-left-radius: 6px; border-bottom-right-radius: 6px;'>"
					+ "<p style='margin: 0; font-size: 13px;'>Best Regards,<br/>Task Management Team</p>" + "</td></tr>"
			...
			body = "<!DOCTYPE html>" + "<html><head><meta charset='UTF-8'><title>Sub Task Updated</title></head>"
					...
					+ "<tr><td style='font-weight: bold; vertical-align: top;'>Description:</td>"
					+ "<td style='width: 600px; white-space: normal; '>" + subtask.getSubTaskDescription()
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Updated By:</td><td>" + createdBy
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Start Date :</td><td>" + formattedStartDate
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Target Date :</td><td>" + formattedTargetDate
					+ "</td></tr>"
					+ "<tr><td style='font-weight: bold; white-space: nowrap; vertical-align: top;'>Assigned Users:</td>"
	...
	@Async
	public void sendTmsCommentEmail(UpdateTask updateTask, boolean task, String Emailsubject, List<String> bccMails,
			List<String> CcMails) throws MessagingException, UnsupportedEncodingException {
		...
		if (task) {
			...
			body = "<!DOCTYPE html>" + "<html><head><meta charset='UTF-8'><title>New Comment</title></head>"
					+ "<body style='font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;'>"
					+ "<table width='100%' cellpadding='0' cellspacing='0' style='padding: 30px 0;'>"
					+ "<tr><td align='center'>"
					+ "<table width='600' cellpadding='0' cellspacing='0' style='background-color: #ffffff; border-radius: 6px;'>"
					...
					+ "<tr><td style='font-weight: bold;'> Task Status:</td><td>" + updateTask.getStatus()
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Comment:</td><td>" + updateTask.getComments()
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Commented By:</td><td>"
					+ getUsersDTO.getFullname() + "</td></tr>" + "</table>" + "</td></tr>"
					+ "<tr><td style='background-color: #f0f0f0; padding: 20px; text-align: center; color: #555; border-bottom-left-radius: 6px; border-bottom-right-radius: 6px;'>"
					+ "<p style='margin: 0; font-size: 13px;'>Best Regards,<br/>Task Management Team</p>" + "</td></tr>"
					+ "</table></td></tr></table></body></html>";
			ccList = CcMails;
			...
			body = "<!DOCTYPE html>" + "<html><head><meta charset='UTF-8'><title>New Comment</title></head>"
					...
					+ "<tr><td style='font-weight: bold;'> Sub Task Status:</td><td>" + updateTask.getStatus()
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Comment:</td><td>" + updateTask.getComments()
					+ "</td></tr>" + "<tr><td style='font-weight: bold;'>Commented By:</td><td>"
					+ getUsersDTO.getFullname() + "</td></tr>" + "</table>" + "</td></tr>"
					+ "<tr><td style='background-color: #f0f0f0; padding: 20px; text-align: center; color: #555; border-bottom-left-radius: 6px; border-bottom-right-radius: 6px;'>"
	...
	@Async
	public void sendStatusUpdateEmail(TmsTask task, String Emailsubject, List<String> bccMails, List<String> CcMails)
			throws MessagingException, UnsupportedEncodingException {
...
//		helper.setCc(ccmail);
		...
		String subject = (Emailsubject != null && !Emailsubject.isBlank()) ? Emailsubject
				: "Task Status Updated: " + task.getTaskname();

		String body = "<!DOCTYPE html>" + "<html><head><meta charset='UTF-8'><title>New Comment</title></head>"
				+ "<body style='font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;'>"
				+ "<table width='100%' cellpadding='0' cellspacing='0' style='padding: 30px 0;'>"
				+ "<tr><td align='center'>"
				+ "<table width='600' cellpadding='0' cellspacing='0' style='background-color: #ffffff; border-radius: 6px;'>"
				...
				+ "<tr><td style='font-weight: bold;'>Updated date And Time:</td><td>"
				+ task.getUpdateddate().format(dateTimeFormatter) + "</td></tr>" + "</table>" + "</td></tr>"
				+ "<tr><td style='background-color: #f0f0f0; padding: 20px; text-align: center; color: #555; border-bottom-left-radius: 6px; border-bottom-right-radius: 6px;'>"
				+ "<p style='margin: 0; font-size: 13px;'>Best Regards,<br/>Task Management Team</p>" + "</td></tr>"
				+ "</table></td></tr></table></body></html>";
		helper.setSubject(subject);
	...
	@Async
	public void sendSubtaskStatusUpdateEmailTms(TmsSubTask subTask, String Emailsubject, List<String> bccMails,
			List<String> CcMails) throws MessagingException, UnsupportedEncodingException {
		...
		String body = "<!DOCTYPE html>" + "<html><head><meta charset='UTF-8'><title>New Comment</title></head>"
				...
				+ "<tr><td style='font-weight: bold;'>Updated By:</td><td>" + getUsersDTO.getFullname() + "</td></tr>"
				+ "<tr><td style='font-weight: bold;'>Updated date And Time:</td><td>"
				+ subTask.getUpdateddate().format(dateTimeFormatter) + "</td></tr>" + "</table>" + "</td></tr>"
				+ "<tr><td style='background-color: #f0f0f0; padding: 20px; text-align: center; color: #555; border-bottom-left-radius: 6px; border-bottom-right-radius: 6px;'>"
				+ "<p style='margin: 0; font-size: 13px;'>Best Regards,<br/>Task Management Team</p>" + "</td></tr>"
				+ "</table></td></tr></table></body></html>";
		helper.setSubject(subject);
